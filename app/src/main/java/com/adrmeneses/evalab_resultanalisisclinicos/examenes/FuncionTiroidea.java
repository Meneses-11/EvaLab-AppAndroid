...
public class FuncionTiroidea extends MenuCategorias {
    ...
    String[][] enfermedades = {{"Hipertiroidismo",null,""+R.string.strInfEnfermHipertiroidismo,"T4 Total,alto","T3 Total,alto","TSH,bajo","T4 Libre,alto","T3 Libre,alto"},{"Hipotiroidismo",null,""+R.string.strInfEnfermHipotiroidismo,"T4 Total,bajo","T3 Total,bajo","TSH,alto","T4 Libre,bajo","T3 Libre,bajo"}};
