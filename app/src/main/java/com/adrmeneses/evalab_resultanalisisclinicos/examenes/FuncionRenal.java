...
public class FuncionRenal extends MenuCategorias {
    ...
    String[][] enfermedades = {{"Insuficiencia renal crónica",null,"Creatinina Sérica,alto","Creatinina Urinaria,alto","BUN,alto"},{"Glomerulonefritis",null,"Proteinuria,alto","Microalbuminuria,alto"},{"Acidosis Tubular Renal",null,"Bicarbonato,bajo","Potasio,alto"},{"Insuficiencia renal aguda",null,"BUN,alto","Creatinina Sérica,alto","Creatinina Urinaria,alto"}};
