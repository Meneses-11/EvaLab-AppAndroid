...
public class HemogramaCompleto extends MenuCategorias {
    ...
    String[][] enfermedades = {{"Anemia","bajo",""+R.string.strInfEnfermAnemia,"Hemoglobina","Eritrocitos"},{"Infeccion Bacteriana","alto",""+R.string.strInfEnfermInfeccBact,"Leocucitos","Neutrofilos"},{"Infeccion Viral","alto",""+R.string.strInfEnfermInfeccViral,"Leocucitos","Linfocitos"},{"Desordenes de Coagulacion","bajo",""+R.string.strInfEnfermDesordCoag,"Plaquetas"},{"Problemas Renales","ambos",""+R.string.strInfEnfermProbRen,"Hematocrito"},{ "Desordenes de la Medula Osea","ambos",""+R.string.strInfEnfermDesordMedOsea,"Hemoglobina","Leocucitos","Plaquetas"},{ "Reacciones Alergicas o Asma","alto",""+R.string.strInfEnfermReacAlerg,"Eosinofilos"},{"Infecciones Parasitarias","alto",""+R.string.strInfEnfermInfeccPara,"Eosinofilos"}};
