...
public class FuncionHepatica extends MenuCategorias {
    ...
    private String[][] parametrosFunHepatica = {{"Alanina Transaminasa","7","50",null,null,null,null,null,null,null,null,"UI/L",""+R.string.strInfHepaticaALT},{"Aspartato Transaminasa","10","50",null,null,null,null,null,null,null,null,"U/L",""+R.string.strInfHepaticaAST},{"Fosfatasa Alcalina","31","129",null,null,null,null,null,null,null,null,"U/L",""+R.string.strInfHepaticaFosAlc},{"Gamma glutamil transferasa","8","65",null,null,null,null,null,null,null,null,"U/L",""+R.string.strInfHepaticaGGT},{"Tiempo de protombina","10","15",null,null,null,null,null,null,null,null,"seg",""+R.string.strInfHepaticaTiPro},{"Albumina","3.5","5",null,null,null,null,null,null,null,null,"g/dL",""+R.string.strInfHepaticaAlbumina},{"Bilirrubina Directa","0.01","0.3",null,null,null,null,null,null,null,null,"mg/dL",""+R.string.strInfHepaticaBiliDirecta},{"Bilirrubina Total","0.3","1",null,null,null,null,null,null,null,null,"mg/dL",""+R.string.strInfHepaticaBiliTotal}};
    ...
    String[][] enfermedades = {{"Daño Hepatico","alto",""+R.string.strInfEnfermDañoHepatico,"Alanina Transaminasa","Aspartato Transaminasa","Fosfatasa Alcalina"},{"Problemas en el Hígado","alto",""+R.string.strInfEnfermProbHigado,"Bilirrubina Total","Bilirrubina Directa"}};
